        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/gongzuoliu/getDict",
        			datatype : "json",
        			height : 450,
        			...
        			editurl : "${contextPath}/sys/gongzuoliu/operateDict"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		if(<shiro:hasPermission name="${ROLE_KEY}:dict:export">true</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:dict:export">false</shiro:lacksPermission>){
    				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
   				       ...
   				       onClickButton : function () { 
   				    	   ...
   				    	   var form = "<form name='csvexportform' action='${contextPath}/sys/gongzuoliu/operateDict?oper=excel' method='post'>";
